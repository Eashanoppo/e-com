    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-6">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-white rounded-[48px] p-12 lg:p-24 text-center shadow-lg relative overflow-hidden group border border-primary/5"
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-4xl lg:text-7xl font-heading text-primary leading-tight mb-8">
              Ready to Stain <br />
